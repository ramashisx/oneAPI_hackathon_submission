...
def main():
    ...
    if args.dataset_name is not None:
        ...
        if args.train_file is not None:
            extension = args.train_file.split(".")[-1]
            train_dataset = load_dataset(extension, data_files=[args.train_file])
        if args.validation_file is not None:
            extension = args.train_file.split(".")[-1]
            eval_dataset = load_dataset(extension, data_files=[args.validation_file])
    ...
    pruning_end = pruning_start*3+10

    print(pruning_start, pruning_end)
